...
def regula_falsi(expresion_func, a, b, tol=1e-6, maxiter=100):
    """
    Menerapkan metode Regula Falsi untuk menemukan akar dari sebuah fungsi.
    """
    ...
    while True:
        ...
        if (fb - fa) == 0:
            print("Pembagian nol (f(b) - f(a) = 0). Metode gagal.")
            return None
